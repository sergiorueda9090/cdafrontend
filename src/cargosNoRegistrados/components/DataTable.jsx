...
import { showThunk, deleteThunk } from '../../store/cargosNoRegistradostore/cargosNoRegistradostoreThunks';

export function DataTable() {

    const dispatch = useDispatch();
    
    let { cargoNoDeseadoArray }    = useSelector(state => state.cargosNoRegistradostore);
  ...
  return (
    <Paper sx={{ padding: 2, height: 700, width: '100%' }}>
      ...
      <Box display="flex" justifyContent="space-between" marginBottom={2}>
          ...
          <DateRange  cotizador="cargosnoregistrados"/>  {/* Componente para selección de rango de fechas */}
      </Box>

      <DataGrid
        rows={cargoNoDeseadoArray}
        columns={columns}
