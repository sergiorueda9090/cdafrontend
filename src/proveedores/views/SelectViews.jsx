...
import { getAllThunks as listarEtiquetas } from "../../store/etiquetasStore/etiquetasThunks";
    ...
    return (
        <Box sx={{
            ...
            <Box sx={{
                ...
                {/* Botón Crear Proveedor - Responsive */}
                <Button
                    color="primary"
                    variant="contained"
                ...
                >
                    {isMobile ? 'Nuevo Proveedor' : 'Crear Proveedor'}
                </Button>
            </Box>
