...
export const archivocotizacionesantiguasStore = createSlice({
  name: 'archivocotizacionesantiguasStore',
  initialState: {
    cotizadores   : [],
    etiquetaDos   : "",
    idEtiqueta    : null,
...
export const { listStore, resetFormularioStore, showStore } = archivocotizacionesantiguasStore.actions;