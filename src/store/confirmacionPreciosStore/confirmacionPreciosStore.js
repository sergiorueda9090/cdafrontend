...
export const confirmacionPreciosStore = createSlice({
  name: 'confirmacionPreciosStore',
  initialState: {
    id              : '',
    idUsuario       : '',
    idCliente       : '',
...
export const { showStore, listStore, resetFormularioStore } = confirmacionPreciosStore.actions;