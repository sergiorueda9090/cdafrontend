...
import { showStore, listStore, resetFormularioStore, handleFormStore  } from "./ajustesSaldoStore.js";

// Función asincrónica para obtener los Pokemons
const parametersURL = 'ajustessaldo/api/';
...
export const getAllThunks = () => {
    ...
    return async (dispatch, getState) => {
        ...
        const options = {
            method: 'GET',
            url: `${ URL}/${parametersURL}ajustessaldo/`,
            headers: {
        ...
        try {
            ...
            if(response.status === 200){
                ...
                if(data.length > 0){
                    ...
                    await dispatch(listStore({'ajuestesSaldo':[]}))
...
export const createThunks = (data) => {
    ...
    return async (dispatch, getState) => {
        ...
        const options = {
            method: 'POST',
            url: `${URL}/${parametersURL}ajustessaldo/crear/`,
            headers: {
                Authorization: `Bearer ${token}`,
...
export const showThunk= (id = "") => {
    ...
    return async (dispatch, getState) => {
        ...
        const options = {
            method: 'GET',
            url: `${ URL}/${parametersURL}ajustessaldo/${id}/`,
            headers: {
              Authorization: `Bearer ${token}`
            }
          };
...
export const updateThunks = (data) => {
    ...
    return async (dispatch, getState) => {
        ...
        const options = {
            method: 'PUT',
            url: `${URL}/${parametersURL}ajustessaldo/${data.id}/update/`,
            headers: {
                Authorization: `Bearer ${token}`,
                'content-type': 'multipart/form-data; boundary=---011000010111000001101001'
              },
...
export const deleteThunk = (idUser = "") => {
    ...
    return async (dispatch, getState) => {
        ...
        const options = {
            method: 'DELETE',
            url: `${ URL}/${parametersURL}ajustessaldo/${idUser}/delete`,
            headers: {
              Authorization: `Bearer ${token}`
            }
          };
