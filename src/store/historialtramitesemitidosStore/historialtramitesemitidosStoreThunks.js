...
import { listStore, showStore  } from "./historialtramitesemitidosStore.js";
...
export const sendToThunk= (id = "") => {
    ...
    return async (dispatch, getState) => {
        ...
        const options = {
            method: 'GET',
            url: `${ URL}/historialtramitesemitidos/api/senttohistorialtramitesemitidos/${id}/`,
            headers: {
              Authorization: `Bearer ${token}`
            }
          };
...
export const showThunk= (id = "") => {
    ...
    return async (dispatch, getState) => {
        ...
        const options = {
            method: 'GET',
            url: `${ URL}/historialtramitesemitidos/api/gethistorialtramitesemitidos/${id}/`,
            headers: {
              Authorization: `Bearer ${token}`
            }
          };
                ...
                await dispatch(showStore(
                    {
                      ...
                      precios_ley            : response.data.precioDeLey ?? '',  // Se asume que 'precioDeLey' corresponde a 'precios_ley'
