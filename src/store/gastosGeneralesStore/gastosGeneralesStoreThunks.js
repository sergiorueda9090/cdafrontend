...
import { showStore, listStore, resetFormularioStore, handleFormStore  } from "./gastosGeneralesStore.js";

// Función asincrónica para obtener los Pokemons
const parametersURL = 'gastosgenerales/api/';
...
export const getAllThunks = () => {
    ...
    return async (dispatch, getState) => {
        ...
        const options = {
            method: 'GET',
            url: `${ URL}/${parametersURL}gastosgenerales/`,
            headers: {
        ...
        try {
            ...
            if(response.status === 200){
                ...
                if(data.length > 0){
                    ...
                    await dispatch(listStore({'gastosGenerales':data}))

                    await dispatch(hideBackDropStore());

                }else{

                    await dispatch(listStore({'gastosGenerales':[]}))
...
export const createThunks = (data) => {
    ...
    return async (dispatch, getState) => {
        ...
        const options = {
            method: 'POST',
            url: `${URL}/${parametersURL}gastosgenerales/crear/`,
            headers: {
                Authorization: `Bearer ${token}`,
...
export const showThunk= (id = "") => {
    ...
    return async (dispatch, getState) => {
        ...
        const options = {
            method: 'GET',
            url: `${ URL}/${parametersURL}gastosgenerales/${id}/`,
            headers: {
              Authorization: `Bearer ${token}`
            }
          };
...
export const updateThunks = (data) => {
    ...
    return async (dispatch, getState) => {
        ...
        const options = {
            method: 'PUT',
            url: `${URL}/${parametersURL}gastosgenerales/${data.id}/update/`,
            headers: {
                Authorization: `Bearer ${token}`,
                'content-type': 'multipart/form-data; boundary=---011000010111000001101001'
              },
...
export const deleteThunk = (idUser = "") => {
    ...
    return async (dispatch, getState) => {
        ...
        const options = {
            method: 'DELETE',
            url: `${ URL}/${parametersURL}gastosgenerales/${idUser}/delete`,
            headers: {
              Authorization: `Bearer ${token}`
            }
          };
...
export const getAllThunksFilter = (fechaInicio, fechaFin) => {
    ...
    return async (dispatch, getState) => {
        ...
        let url = `${ URL}/${parametersURL}gastosgenerales/listar_gastos_generales_filtradas/`;
