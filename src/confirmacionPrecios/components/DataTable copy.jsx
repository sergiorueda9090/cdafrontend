  ...
  return (
    <Box sx={{ height: '100vh', width: '100%', display: 'flex', flexDirection: 'column' }}>
      ...
      <Box 
        sx={{ 
          display: 'flex', 
          // Columna en móviles/tablets pequeñas, Fila en escritorio
          flexDirection: { xs: 'column', lg: 'row' }, 
          justifyContent: 'space-between', 
          alignItems: { xs: 'stretch', lg: 'center' }, 
          gap: 2, 
          marginBottom: 4, // Un poco más de espacio para que la tabla no se vea "ahogada"
          width: '100%',
          // Agregamos un fondo sutil o elevación si quieres que se vea como un panel
          backgroundColor: '#fff',
          borderRadius: '8px',
        }}
      >
        ...
        <Box sx={{ 
          display: 'flex', 
          flexDirection: { xs: 'column', sm: 'row' }, // En tablets pequeñas el calendario también puede apilarse
          alignItems: 'center',
          gap: 1,
